function calculateFees() {
	...
	result += "Monthly Fee:".padEnd(column1Width) + `${effectiveRate.toFixed(4)}%`.padEnd(column2Width) + totalFee.toFixed(2).padStart(column3Width) + "\n";
	result += "Annual Fee:".padEnd(column1Width) + `${effectiveRateAnnual.toFixed(4)}%`.padEnd(column2Width) + (totalFee * 12).toFixed(2).padStart(column3Width) + "\n";
